...
D - E - F - G
    ...
    H
=#
function test_continuous_mapf(mapf_func::Function)
    edge_list =
        Edge.([(1, 2), (2, 3), (2, 4), (2, 6), (3, 6), (4, 5), (5, 6), (6, 7), (6, 8)])
    ...
    valid_vertices, valid_edges, objective = mapf_func(
        network,
        source_vertices,
        target_vertices,
        vertex_wait_time,
...
test_continuous_mapf(mapf_continuous_time)
test_continuous_mapf(mapf_continuous_time_dynamic_conflict)
